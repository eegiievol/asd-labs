...
public class Application {
	...
	public static void main(String[] args) {
		...
		//age based iterator
		System.out.println("age based iterator:");

		Iterator<Customer> iterator = customerCollection.sortedIterator();
		while (iterator.hasNext()) {
			System.out.println(iterator.next());
		}

		//filter based iterator
		System.out.println("filter based iterator:");
		Predicate<Customer> predicate = p -> p.getAddress().getCity().equals("Chicago") && p.getAddress().getZip().startsWith("12");
		Iterator<Customer> iterator2 = customerCollection.filterIterator(predicate);
		while (iterator2.hasNext()) {
			System.out.println(iterator2.next());
		}

		//1 skipping iterator
		System.out.println("1 skipping iterator:");

		Iterator<Customer> iterator3 = customerCollection.doubleIterator();
