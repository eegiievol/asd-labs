...
public class JFrameCounter extends JFrame {
    ...
    public JFrameCounter() {
        ...
        try {
            ...
            counter.setObserver(textframe);
            counter.setObserver(rectframe);
            counter.setObserver(ovalframe);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void jButtonIncrement_actionPerformed(ActionEvent e) {
        ...
        CounterHistory.addCommand(incrementCommand);
    }
    ...
    private void jButtondecrement_actionPerformed(ActionEvent e) {
        ...
        CounterHistory.addCommand(decrementCommand);
